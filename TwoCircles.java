...
public class TwoCircles {
	...
	static String[] circles(String[] info) {
		...
		for (int i = 0; i < testCount; i++) {
			...
			} else if ((r2 >= r1 && Math.sqrt(distancesq) <= (r2 - r1))
					|| ((r1 >= r2 && Math.sqrt(distancesq) <= (r1 - r2)))) {
	...
	public static void main(String[] args) {
		String[] info = { "12 0 21 14 0 23", "0 45 8 0 94 9", "35 0 13 10 0 38", "0 26 8 0 9 25" };
		String[] result = circles(info);
		for (String s : result) {
			System.out.println(s);
		}

		String[] info1 = { "0 5 9 0 9 7", "0 15 11 0 20 16", "26 0 10 39 0 23", "37 0 5 30 0 11", "41 0 0 28 0 13" };
